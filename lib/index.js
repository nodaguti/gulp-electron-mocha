...
exports.default = function () {
  ...
  var electronMochaPath = lookup('electron-mocha/bin/electron-mocha', false);
...
function spawnElectronMocha(paths, opts, stream, cb) {
  var args = [paths.electronMocha].concat((0, _toConsumableArray3.default)(opts.electronMocha), [paths.file]);
  var env = (0, _objectAssign2.default)(process.env, { 'ELECTRON_PATH': paths.electron });
  var electronMocha = (0, _child_process.spawn)(process.argv[0], args, { env: env });
